...
export default function TrenaImageInput({ media, onChangeMedia }: any) {
  ...
  const [currentImageUri, setCurrentImageUri] = useState(media.uri);
  const [comments, setComments] = useState<string>(media.comments);
  const [type, setType] = useState<string>(media.type);
