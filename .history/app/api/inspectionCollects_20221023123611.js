...
const addInspectionCollect = async (data, onUploadProgress) => {
  ...
  data.images.forEach(async (media, index) => {
    ...
    const imageUriParts = media.split(".")
    ...
    const photoData = {
      ...
      type: "1",
      filepath: "images/" + data.inspection.public_work_id + "_" + timestamp + "_" + "." + extension,
    ...
    photoFilesData.append("file",  
         {
            name: data.inspection.public_work_id + "_" + timestamp + "_" + "." + extension,
